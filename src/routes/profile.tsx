  ...
  return (
    <main className="mx-auto max-w-md px-4 pt-6 animate-fade-in">
      ...
      <Section title="Library">
        ...
        <Row to="/profile/history" icon={History} label={`Watch History (${history.length})`} />
      </Section>
...
}: { to: string; icon: any; label: string; accent?: boolean }) {
  return (
    <Link to={to} className="flex items-center gap-3 rounded-xl bg-card p-3 ring-1 ring-white/5 hover:ring-primary/40">
